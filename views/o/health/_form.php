...
<fieldset>
	...
	<div class="clearfix">
		<?php echo $form->labelEx($model,'disease_ever'); ?>
		<div class="desc">
			<?php echo $form->textArea($model,'disease_ever',array('rows'=>6, 'cols'=>50)); ?>
			<?php echo $form->error($model,'disease_ever'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'disease_frequently'); ?>
		<div class="desc">
			<?php echo $form->textArea($model,'disease_frequently',array('rows'=>6, 'cols'=>50)); ?>
			<?php echo $form->error($model,'disease_frequently'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'disease_physical'); ?>
		<div class="desc">
			<?php echo $form->textArea($model,'disease_physical',array('rows'=>6, 'cols'=>50)); ?>
			<?php echo $form->error($model,'disease_physical'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>

	<div class="clearfix">
		<?php echo $form->labelEx($model,'height_and_weight'); ?>
		<div class="desc">
			<?php echo $form->textArea($model,'height_and_weight',array('rows'=>6, 'cols'=>50)); ?>
			<?php echo $form->error($model,'height_and_weight'); ?>
			<?php /*<div class="small-px silent"></div>*/?>
		</div>
	</div>
